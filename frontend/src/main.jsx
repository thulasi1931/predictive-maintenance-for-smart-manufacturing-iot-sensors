...
function App({ onLogout, theme, toggleTheme }) {
  ...
  useEffect(() => { loadHistory(); loadAlerts(); loadSettings(); loadMetrics(); searchAssets("M14860"); return () => clearInterval(timer.current); }, []);
